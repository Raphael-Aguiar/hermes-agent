...
_MEMORY_REVIEW_PROMPT = (
    ...
    "When you consolidate: read the current entries first and use exact literal "
    "old_text (never paraphrase); batches are all-or-nothing, so keep them small. "
    "Never rewrite the whole memory in one sweep. Before dropping an operational "
    "detail, make sure it already lives in a skill or in the vault and leave a "
    "short pointer to it.\n\n"
